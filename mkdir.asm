...
printint(int fd, int xx, int base, int sgn)
{
 ...
 412:	0f b6 80 b4 0a 00 00 	movzbl 0xab4(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 54e:	75 25                	jne    575 <printf+0xff>
          s = "(null)";
 550:	c7 45 f4 5f 08 00 00 	movl   $0x85f,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 6e1:	a3 d0 0a 00 00       	mov    %eax,0xad0
}
 6e6:	90                   	nop
 6e7:	c9                   	leave  
 6e8:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 73f:	83 c4 10             	add    $0x10,%esp
  return freep;
 742:	a1 d0 0a 00 00       	mov    0xad0,%eax
}
 747:	c9                   	leave  
 748:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 75b:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 75e:	a1 d0 0a 00 00       	mov    0xad0,%eax
 763:	89 45 f0             	mov    %eax,-0x10(%ebp)
 766:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 76a:	75 23                	jne    78f <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 76c:	c7 45 f0 c8 0a 00 00 	movl   $0xac8,-0x10(%ebp)
 773:	8b 45 f0             	mov    -0x10(%ebp),%eax
 776:	a3 d0 0a 00 00       	mov    %eax,0xad0
 77b:	a1 d0 0a 00 00       	mov    0xad0,%eax
 780:	a3 c8 0a 00 00       	mov    %eax,0xac8
    base.s.size = 0;
 785:	c7 05 cc 0a 00 00 00 	movl   $0x0,0xacc
 78c:	00 00 00 
  }
 ...
 7e2:	a3 d0 0a 00 00       	mov    %eax,0xad0
      return (void*)(p + 1);
 ...
 7ed:	eb 3b                	jmp    82a <malloc+0xe1>
    ...
    if(p == freep)
 7ef:	a1 d0 0a 00 00       	mov    0xad0,%eax
